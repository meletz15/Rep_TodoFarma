-- Script de datos de prueba corregido para los nuevos módulos
...
INSERT INTO proveedores (nombre, apellido, correo, telefono, direccion, empresa, estado) 
VALUES ('Juan', 'Pérez', 'juan@farmaciacentral.com', '555-0101', 'Av. Principal 123', 'Farmacia Central', 'ACTIVO')
ON CONFLICT (correo) DO NOTHING;

-- Insertar productos de prueba si no existen
INSERT INTO producto (nombre, descripcion, precio_unitario, stock, id_categoria, id_marca, activo) 
VALUES 
...
INSERT INTO cliente (nombres, apellidos, telefono, correo, direccion, estado) 
VALUES ('María', 'González', '555-0202', 'maria@email.com', 'Calle Secundaria 456', 'ACTIVO')
ON CONFLICT (correo) DO NOTHING;
...
SELECT p.nombre, p.stock, p.precio_unitario 
FROM producto p 
